...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@StringGentg_bot](tg://openmessage?user_id=625999441) \nA Bot By @B0RNTOLE4RN")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/b0rntole4rn'),
                InlineKeyboardButton('Developer', url='https://t.me/b0rntole4rn')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/b0rntole4rn'),
            ]
        ]
    )
